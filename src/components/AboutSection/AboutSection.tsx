...
const stats = [
  ...
  { icon: <Code2 className="w-6 h-6" />, label: "Projects Completed", value: "25+" },
  { icon: <Users className="w-6 h-6" />, label: "Happy Clients", value: "15+" },
  { icon: <Globe2 className="w-6 h-6" />, label: "Location", value: "Jambi, ID" },
];
        ...
        <div className="flex-1 space-y-8">
          <div>
            ...
            <p className="text-lg text-muted-foreground leading-relaxed">
              I am a dedicated Full-Stack Web Developer based in Jambi, Indonesia with over 2 years of experience 
              building responsive, user-centric web applications and robust digital platforms. I specialize in 
              modern web technologies, turning creative concepts into scalable, production-ready software solutions.
            </p>
          </div>
        </div>
