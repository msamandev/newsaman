...
export const EducationSection = () => {
  const education = [
    {
      degree: "Bachelor of Arabic Language and Literature (S.Hum)",
      school: "Sulthan Thaha Saifuddin State Islamic University Jambi",
      year: "2014 – 2018",
      badge: "Bachelor of Humanities",
      badgeIcon: Award,
      badgeColor: "text-emerald-400 bg-emerald-500/10 border-emerald-500/30",
      icon: GraduationCap,
      details: [
        "Specialized in Arabic Linguistics, Structural Morphology (Sharaf), Advanced Syntax (Nahwu), and Literary Semantics.",
        "Cultivated rigorous analytical thinking, syntax parsing, and pattern recognition skills that directly empower systematic programming and problem-solving.",
        "Conducted in-depth academic research, comparative textual studies, and literary analyses following rigorous scientific methodologies.",
        "Participated actively in student academic discussions, language immersion workshops, and cultural-humanities forums.",
      ],
    },
  ];
      ...
      <div>
        ...
        >
          ...
          <p className="text-muted-foreground text-lg max-w-2xl">
            Cultivating strong analytical reasoning, linguistic precision, and systematic research methodologies.
          </p>
        </motion.div>
        ...
        <div className="w-full max-w-4xl">
          {education.map((edu, i) => {
            ...
            return (
              ...
              >
                <MagicCard
                  className="h-full p-8 md:p-10 rounded-[2.25rem] border border-border/80 bg-card/80 shadow-xl"
                  gradientSize={350}
                    ...
                    <div>
                      ...
                      <ul className="space-y-3.5">
                        {edu.details.map((detail, j) => (
                          <li key={j} className="text-sm md:text-base text-muted-foreground flex items-start gap-3 leading-relaxed">
