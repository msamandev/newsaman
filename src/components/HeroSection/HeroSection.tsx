        ...
        >
          ...
          >
            ...
            <div className="block dark:hidden">
              <span className="bg-gradient-to-r from-violet-600 via-sky-500 via-purple-600 to-indigo-600 bg-clip-text text-transparent font-extrabold text-[clamp(2.5rem,5.5vw,4.5rem)] leading-none tracking-tight block pb-2 select-none">
                M. Saman, S. Hum
              </span>
            </div>
          ...
          >
            Full-Stack Web Developer based in Jambi, Indonesia. Passionate about engineering clean, scalable, and high-performance digital web applications.
          </motion.p>
          ...
          >
            <div className="flex flex-col h-full bg-card w-full">
              ...
              <div className="p-5 flex flex-col items-center text-center bg-card text-card-foreground flex-1 gap-3">
                <div>
                  <h3 className="text-xl font-extrabold tracking-tight text-foreground">M. Saman, S. Hum</h3>
                ...
                <div className="grid grid-cols-2 gap-2.5 w-full text-left bg-muted/40 p-3 rounded-xl border border-border/50">
                  ...
                  <div>
                    ...
                    <span className="font-bold text-foreground text-xs">Jambi, Indonesia</span>
                  </div>
                  <div>
