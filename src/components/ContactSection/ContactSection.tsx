        ...
        <div className="relative z-10 flex flex-col md:flex-row gap-12 md:gap-24">
          ...
          <div className="flex-1 space-y-8">
            ...
            <div className="space-y-6">
              <a 
                href="mailto:admin@muhsaman.web.id" 
              ...
              >
                ...
                <span className="font-medium">admin@muhsaman.web.id</span>
              </a>
              <a 
                href="https://wa.me/6285669570492" 
                target="_blank" 
              ...
              >
                ...
                <span className="font-medium">+62 856-6957-0492</span>
              </a>
              <div className="flex items-center gap-4 text-muted-foreground hover:text-primary transition-colors cursor-pointer group">
                ...
                <span className="font-medium">Jambi, Indonesia</span>
              </div>
            </div>
          </div>
